...
class about(models.Model):
    ...
    # imgprofile=models.ImageField(_("الصورة الرئيسية"), upload_to=None, height_field=None, width_field=None, max_length=None)
    class Meta:
...
class Product(models.Model):
    ...
    # id=models.ForeignKey("app.Model", verbose_name=_(""), on_delete=models.CASCADE)
    ...
    product_image = models.ImageField(
        upload_to='products/imgs/', default='products/product.jpg', max_length=500, verbose_name=_("صورة رئيسية للمنتج"),null=False)
    ...
    additional_image_1 = models.ImageField(
        upload_to='products/imgs/product_imgs/', blank=True, null=True, max_length=500, verbose_name=_("صورة2 لنفس المنتج"), )

    additional_image_2 = models.ImageField(
        upload_to='products/imgs/product_imgs/', blank=True, null=True, max_length=500, verbose_name=_("صورة 3 لنفس المنتج"), )
    # url = models.URLField()
